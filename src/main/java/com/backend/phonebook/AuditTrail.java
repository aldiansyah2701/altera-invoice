...
import com.backend.phonebook.repository.LoggingRepository;
...
public class AuditTrail {
	...
	@Before("execution(* com.backend.phonebook.controller.*.*.*(..))")
	...
	@AfterReturning(pointcut = "(execution(* com.backend.phonebook.controller.*.*.*(..))) ", returning = "result")
